...
function createScreenShareOffer(instanceId, stunTurnJson) {
  return new Promise((res, rej) => {
    ...
    try {
      console.log(`[${instanceId}] - >nativeCreateScreenShareOffer (${stunTurnJson})`); // call native swift method that triggers the broadcast popup
...
var _default = createScreenShareOffer;
