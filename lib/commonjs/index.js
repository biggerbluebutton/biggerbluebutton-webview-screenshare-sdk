...
const BigBlueButtonTablet = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderPlatformSpecificComponents(), /*#__PURE__*/_react.default.createElement(_reactNativeWebview.WebView, {
    ref: webViewRef,
    source: {
      uri: url
    },
    ...
    contentMode: 'mobile',
    onMessage: msg => (0, _messageHandler.handleWebviewMessage)(thisInstanceId, webViewRef, msg),
